...
import { FarmerStatementPage } from "./pages/FarmerStatementPage";
  ...
  return (
    <Routes>
      ...
      <Route element={<AppShell />}>
        ...
        <Route path="/trips/:tripId" element={<NewTripPage />} />
        <Route path="/farmers" element={<FarmersPage />} />
        <Route path="/farmers/new" element={<NewFarmerPage />} />
        <Route path="/farmers/:farmerId" element={<FarmerProfilePage />} />
        <Route path="/farmers/:farmerId/statement" element={<FarmerStatementPage />} />
